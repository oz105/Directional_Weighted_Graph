...
//		g.clearRect(0, 0, w, h);
    ...
    private void drawPokemons(Graphics g) {
        ...
        if (fs != null) {
            ...
            while (itr.hasNext()) {
                ...
                Image crazyPok = toolkit.getImage("resources\\hatPok.png");
                Image glassPok = toolkit.getImage("resources\\classicPok.png");
                Image img = crazyPok;
    ...
    private void drawAgants(Graphics g) {
        ...
        Graphics2D graphics2D = (Graphics2D) g;
        Toolkit toolkit = Toolkit.getDefaultToolkit();
        Image agent = toolkit.getImage("resources\\ketch.png");
...
//                g.fillOval((int) fp.x() - r, (int) fp.y() - r, 2 * r, 2 * r);
    ...
    private void drawNode(node_data n, int r, Graphics g) {
        Graphics2D graphics2D = (Graphics2D) g;
        Toolkit toolkit = Toolkit.getDefaultToolkit();
        Image location = toolkit.getImage("resources\\location.png");
